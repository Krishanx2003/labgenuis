              ...
              <div className="h-full px-4 py-6 lg:px-8">
                <section className="wrapper my-8">
                  <div className="flex flex-col gap-4">
                    ...
                    <p className="rounded-lg bg-gray-100 px-3 py-1 text-xs sm:text-sm dark:bg-gray-800">
                  ...
                  <div className="space-y-4 text-left">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <p className="mx-auto max-w-3xl text-gray-500 md:text-lg lg:text-base xl:text-lg dark:text-gray-400">
                        {project.description}
                      </p>
                    </div>
