        ...
        >
          <div className="flex flex-col md:flex-row gap-10 bg-white rounded-md rounded-tr-md rounded-br-md hover:shadow-md duration-200">
            <div className="w-full md:w-3/5 group overflow-hidden rounded-tl-md rounded-bl-md relative">
              {post?.mainImage && ( // Check if mainImage is defined
                <Image
                  src={urlFor(post?.mainImage)?.url()} // Add optional chaining
                  width={500}
                  height={500}
                  alt="blog post image"
                />
              )}
              <div className="absolute top-0 left-0  w-full h-full group-hover:hidden duration-200" />
            ...
            <div className="w-full md:w-2/5 flex flex-col justify-between py-10 px-4">
              <div className="flex flex-col gap-5">
                ...
                <h2 className="text-2xl font-semibold text-black duration-200 cursor-pointer">
                  {post?.title}
                </h2>
